...
- Generated/downloaded runtime artifacts under `data/raw/`, `data/cache/`, `data/mappings/`, `data/reference/`, and `data/output/` are local-only.
...
| `data/mappings/` | Final NPI and HCPCS mapping CSVs used by enrichment. | Generated by `build_datasets`. |
| `data/reference/` | API reference parquet datasets (request/response traces for NPI + HCPCS). | Generated by `build_datasets`. |
| `data/output/` | Enriched final dataset output(s). | Generated by `build_datasets`. |
